...
DEFAULT_PERIOD_TEMPLATES = [
    (1, time(8, 0), time(9, 35), (1, 1, 1, 1, 1, 1, 0)),
    (2, time(9, 45), time(11, 20), (1, 1, 1, 1, 1, 1, 0)),
    (3, time(12, 20), time(13, 55), (1, 1, 1, 1, 1, 0, 0)),
    (4, time(14, 5), time(15, 40), (1, 1, 1, 1, 1, 0, 0)),
    (5, time(15, 50), time(17, 25), (1, 1, 1, 1, 1, 0, 0)),
    (6, time(17, 35), time(19, 10), (1, 1, 1, 1, 1, 0, 0)),

    (3, time(11, 50), time(13, 25), (0, 0, 0, 0, 0, 1, 0)),
    (4, time(13, 35), time(15, 10), (0, 0, 0, 0, 0, 1, 0)),
    (5, time(15, 20), time(16, 55), (0, 0, 0, 0, 0, 1, 0)),
    (6, time(17, 5), time(18, 40), (0, 0, 0, 0, 0, 1, 0)),
]
...
def fill_default_period_template():
    ...
    template_objects = [
        PeriodTemplate(
            ...
            end_time=end_time,
            **dict(zip(day_fields, days))
        )
        for lesson_number, start_time, end_time, days in DEFAULT_PERIOD_TEMPLATES
    ]
